        ...
        <div class="goods-item" v-for="(goodItem,idx) in goods" :id='"goodItem"+idx'>
          ...
          <ul class="foods-list">
            <li v-for="(foodItem,index) in goodItem.foods">
              <div class="food-img" @click="selecedFood(idx+'-'+index,foodItem)">
                <img v-bind:src="foodItem.icon" />
              </div>
              <div class="food-context">
                <p class="food-title" v-text="foodItem.name" @click="selecedFood(idx+'-'+index,foodItem)"></p>
                ...
                <div class="change-goods-number">
                  ...
                  <transition name="fade">
                      <a href="javascript:;"  v-show="getFoodNum(idx+'-'+index)>0" @click="cutFoods(idx+'-'+index)" class="link-change  icon-remove_circle_outline" ></a>
                  </transition>
                  ...
                  <a href="javascript:;" class="icon-add_circle link-change add" @click="addFoods(idx+'-'+index,foodItem,index)"></a>
                  <div class="ball-box" :id="index">
                      <transition-group name="flip-list" >
                          <div v-for="(ball,index) in ballarr" :key="index" v-show="ball" class="move-box"></div>
                      </transition-group>
                  </div>
                </div>
              </div>
    ...
    export default {
        data() {
            return {
                ...
                goodDocumentList: [],
                goodClassList: [],
                ballarr: [false, false, false, false, false, false, false, false, false, ],
                ballindex: 0
            };
        },
        components: {
        ...
        methods: {
            ...
            addFoods(idx, item, index) {
                ...
                this.creatBall(index);
            },
            creatBall(index) {
                var ballBox = document.getElementsByClassName('ball-box')[index];
                var rect = ballBox.getBoundingClientRect();
                console.log(rect);
                this.ballarr[this.ballindex] = true;
